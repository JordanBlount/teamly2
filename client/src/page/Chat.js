        ...
        <>
            <TopNav title="Chat" icon={
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M15 13.75H11.25M15 10V13.75V10ZM15 13.75V17.5V13.75ZM15 13.75H18.75H15Z" stroke="#4B4B4B" stroke-width="2" stroke-linecap="round" />
                    <path d="M17.5 23.75C22.2137 23.75 24.5712 23.75 26.035 22.285C27.5 20.8212 27.5 18.4637 27.5 13.75C27.5 9.03625 27.5 6.67875 26.035 5.215C24.5712 3.75 22.2137 3.75 17.5 3.75H12.5C7.78625 3.75 5.42875 3.75 3.965 5.215C2.5 6.67875 2.5 9.03625 2.5 13.75C2.5 18.4637 2.5 20.8212 3.965 22.285C4.78125 23.1025 5.875 23.4638 7.5 23.6225" stroke="#4B4B4B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M17.5001 23.75C15.9551 23.75 14.2526 24.375 12.6988 25.1813C10.2013 26.4775 8.95256 27.1263 8.33756 26.7125C7.72256 26.3 7.83881 25.0188 8.07256 22.4575L8.12506 21.875" stroke="#4B4B4B" stroke-width="2" stroke-linecap="round" />
                </svg>
