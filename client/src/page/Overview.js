        ...
        <>
            ...
            <Section title="Tasks">
                <div className="grid grid-cols-2 gap-2">
                    <div className="w-full bg-gray-200 rounded-md h-28 flex justify-center items-center">
                        Test
                    </div>
                    <div className="w-full bg-[#F6AFAF] rounded-md h-28 flex justify-center items-center">
                        Test
                    </div>
                    <div className="w-full bg-[#CEF6AF] rounded-md h-28 flex justify-center items-center">
                        Test
                    </div>
                    <div className="w-full bg-[#F6E7AF] rounded-md h-28 flex justify-center items-center">
                        Test
                    </div>
                </div>
            </Section>
            <Section title="Latest Threads">
                <div className="grid grid-cols-1 gap-4">
                    {/* NOTE: Example of thread 
                        TODO: Turn into a component */}
                    <div className="w-full rounded-md shadow-md p-6">
                        <p className="text-2xl text-[#4B5078] medium">Engineering team needs updates...</p>
                    ...
                    <div className="w-full rounded-md shadow-md p-6">
                        <p className="text-2xl text-[#4B5078] medium">Updates going out tomorrow</p>
                    ...
                    <ThreadCard title='Updates going out' date='Today' teamName='Update Team' authors={fakeData}/>
                </div>
            </Section>
        </>
    )
